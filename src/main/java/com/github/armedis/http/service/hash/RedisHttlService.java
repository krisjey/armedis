...
import com.github.armedis.redis.command.hash.RedisHttlRequest;
 ...
 */
@Component
public class RedisHttlService extends BaseService {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private static final String REDIS_COMMAND = "httl";
    ...
    public HttpResponse urlencodedWithoutKey(RedisHttlRequest redisRequest) {
    ...
    @Consumes(MediaTypeNames.FORM_DATA)
    public HttpResponse urlencodedWithKey(RedisHttlRequest redisRequest) {
        logger.info("Text request " + REDIS_COMMAND + " command without key at URL " + redisRequest.toString());
