...
public class RedisClusterNodeInfo {
    ...
    public String toString() {
        return "RedisNodeInfo [id=" + id + ", ip=" + ip + ", listenPort=" + listenPort + ", clusterBusPort=" + clusterBusPort + ", flags=" + flags +
                ", masterId=" + masterId + ", pingSend=" + pingSend + ", pongRecv=" + pongRecv + ", configEpoch=" + configEpoch + ", linkState=" + linkState +
    ...
    public boolean equals(Object obj) {
        ...
        return clusterBusPort == other.clusterBusPort && configEpoch == other.configEpoch && Objects.equals(flags, other.flags) &&
                Objects.equals(id, other.id) && Objects.equals(ip, other.ip) && Objects.equals(linkState, other.linkState) && listenPort == other.listenPort &&
                Objects.equals(masterId, other.masterId) && pingSend == other.pingSend && pongRecv == other.pongRecv && shardSlotEnd == other.shardSlotEnd &&
                shardSlotStart == other.shardSlotStart;
    }
}
