...
import com.github.armedis.redis.command.string.RedisSetexRequest;
 ...
 */
@Component
public class RedisSetexService extends BaseService {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String REDIS_COMMAND = "setex";
	...
	/**
	 * Process Setex command request by x-www-form-urlencoded without redis key at
	 * URL.
	 * 
	 * @param redisRequest
	 * @return HttpResponse
	...
	/**
	 * Process Setex command request by x-www-form-urlencoded with redis key at URL.
	 * 
	 * @param redisRequest
	 * @return
	 */
	...
	/**
	 * Process Setex command request by application json without redis key at URL.
	 * 
	...
	/**
	 * Process Setex command request by application json with redis key at URL.
	 * 
	 * When request body is absent then JacksonRequestConverterFunction not working.
	 * <br/>
	 * So, just use AggregatedHttpRequest.contentUtf8() method and convert to
