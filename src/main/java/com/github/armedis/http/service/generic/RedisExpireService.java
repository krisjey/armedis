...
/**
 * Redis Expire http request endpoint service.
 * @author krisjey
 *
 */
@Component
public class RedisExpireService extends BaseService {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private static final String REDIS_COMMAND = "expire";
    ...
    /**
     * Process Expire command request by x-www-form-urlencoded without redis key at URL.
     * @param redisRequest
     * @return HttpResponse
     */
    @Post
    ...
    /**
     * Process Expire command request by x-www-form-urlencoded with redis key at URL.
     * @param redisRequest
     * @return
     */
    @Post
    ...
    /**
     * Process Expire command request by application json without redis key at URL.
     * 
    ...
    /**
     * Process Expire command request by application json with redis key at URL.
     * 
     * When request body is absent then JacksonRequestConverterFunction not working. <br/>
     * So, just use AggregatedHttpRequest.contentUtf8() method and convert to JsonNode.
     * @param httpRequest
