...
@javax.annotation.Generated(
    ...
    comments = "Source: example/armeria/grpc/hello.proto")
public final class HelloServiceGrpc {

  private HelloServiceGrpc() {}

  public static final String SERVICE_NAME = "example.armeria.grpc.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Hello",
      requestType = example.armeria.grpc.HelloRequest.class,
      responseType = example.armeria.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest, example.armeria.grpc.HelloReply> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<example.armeria.grpc.HelloRequest, example.armeria.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.armeria.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.armeria.grpc.HelloReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getLazyHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getLazyHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest, example.armeria.grpc.HelloReply> getLazyHelloMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getBlockingHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getBlockingHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest, example.armeria.grpc.HelloReply> getBlockingHelloMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getLotsOfRepliesMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getLotsOfRepliesMethod() {
    io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest, example.armeria.grpc.HelloReply> getLotsOfRepliesMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getLotsOfGreetingsMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getLotsOfGreetingsMethod() {
    io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest, example.armeria.grpc.HelloReply> getLotsOfGreetingsMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getBidiHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest,
      example.armeria.grpc.HelloReply> getBidiHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.grpc.HelloRequest, example.armeria.grpc.HelloReply> getBidiHelloMethod;
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(example.armeria.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply> responseObserver) {
      asyncUnimplementedUnaryCall(getHelloMethod(), responseObserver);
    }

    /**
     */
    public void lazyHello(example.armeria.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply> responseObserver) {
    ...
    /**
     */
    public void blockingHello(example.armeria.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply> responseObserver) {
    ...
    /**
     */
    public void lotsOfReplies(example.armeria.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<example.armeria.grpc.HelloRequest> lotsOfGreetings(
        io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<example.armeria.grpc.HelloRequest> bidiHello(
        io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                example.armeria.grpc.HelloRequest,
                example.armeria.grpc.HelloReply>(
                  this, METHODID_HELLO)))
          .addMethod(
            getLazyHelloMethod(),
            asyncUnaryCall(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public example.armeria.grpc.HelloReply hello(example.armeria.grpc.HelloRequest request) {
    ...
    /**
     */
    public example.armeria.grpc.HelloReply lazyHello(example.armeria.grpc.HelloRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public example.armeria.grpc.HelloReply blockingHello(example.armeria.grpc.HelloRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public java.util.Iterator<example.armeria.grpc.HelloReply> lotsOfReplies(
        example.armeria.grpc.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<example.armeria.grpc.HelloReply> hello(
        example.armeria.grpc.HelloRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<example.armeria.grpc.HelloReply> lazyHello(
        example.armeria.grpc.HelloRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<example.armeria.grpc.HelloReply> blockingHello(
        example.armeria.grpc.HelloRequest request) {
      return futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((example.armeria.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply>) responseObserver);
          break;
        case METHODID_LAZY_HELLO:
          serviceImpl.lazyHello((example.armeria.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply>) responseObserver);
          break;
        case METHODID_BLOCKING_HELLO:
          serviceImpl.blockingHello((example.armeria.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply>) responseObserver);
          break;
        case METHODID_LOTS_OF_REPLIES:
          serviceImpl.lotsOfReplies((example.armeria.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.grpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return example.armeria.grpc.HelloArmeria.getDescriptor();
    }
