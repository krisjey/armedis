...
(function () {
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			ul.innerHTML = '<a href="#" class="logo"><img src="/assets/images/logo-SK-Inc.-AX_RGB_EN.png" alt="" height="40"></a>';
			...
			var currentPath = location.hash == "/" ? "pages-armedis-overview.html" : location.hash.substring(1);
