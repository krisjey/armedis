...
class RedisSlowlogServiceTest extends AbstractRedisServerTest {

    @Test
    void testSlowlog() throws JsonMappingException, JsonProcessingException {
        String responseString = null;

        RequestHeaders headers = RequestHeaders.builder()
                .method(HttpMethod.GET)
                .path("/v1/management/slowlog/10")
